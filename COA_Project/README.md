...
| **التخصص الدفاعي** | MITRE ATT&CK، تقارير حوادث، YARA ([core/rules/baseline.yar](core/rules/baseline.yar)) مع إمكان **توسيع القواعد** لتهديدات إقليمية؛ دعم ICS/OT ضمن **خارطة طريق** التوسع. |
...
**عرض جاهز للنسخ:** [PITCH_HACKATHON_AR.md](PITCH_HACKATHON_AR.md) · **شرح مدمج:** [شرح_فكرة_المشروع.md](شرح_فكرة_المشروع.md)
